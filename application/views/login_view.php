...
<div class="login-box">
  ...
  <div class="login-logo">
    <a href="index.php" style="color: yellow;">Sistem Informasi <br/><b>E-Library</b></a>
  </div>
  ...
  <footer>
    <div class="login-box-body text-center bg-red">
       <a style="color: yellow;"> Copyright &copy; Sistem Informasi E-Library Silvia wu  - <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
